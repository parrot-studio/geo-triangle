...
Gem::Specification.new do |s|
  s.name = %q{geo-triangle}
  s.version = "0.0.1"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["parrot-studio"]
  s.date = %q{2011-05-19}
  s.description = %q{calculate center of 3 geo-coordinates(lat, lon)}
  ...
  s.homepage = %q{http://github.com/parrot-studio/geo-triangle}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.6.2}
  s.summary = %q{calculate geo-triangle's gravity center}
